...
using Xamarin.Forms;
using Prism.Xamarin.AsyncNavigation.Xaml;
    ...
    public class PageNavigationService : INavigationService, INavigateInternal, IPageAware
    {
        ...
        protected async virtual Task<INavigationResult> GoBackInternal(INavigationParameters parameters, bool? useModalNavigation, bool animated)
        {
            ...
            try
            {
                ...
                GetNavigationParametersInternal(segmentParameters).Add(KnownInternalParameters.NavigationMode, NavigationMode.Back);
                ...
                await onNavigatingToAsync(previousPage, segmentParameters);
        ...
        protected async virtual Task<INavigationResult> GoBackToRootInternal(INavigationParameters parameters)
        {
            ...
            try
            {
                ...
                GetNavigationParametersInternal(parameters).Add(KnownInternalParameters.NavigationMode, NavigationMode.Back);
                ...
                await onNavigatingToAsync(root, parameters);
        ...
        protected static async Task DoNavigateAction(Page fromPage, string toSegment, Page toPage, INavigationParameters parameters, Func<Task> navigationAction = null, Action onNavigationActionCompleted = null)
        {
            ...
            GetNavigationParametersInternal(segmentParameters).Add(KnownInternalParameters.NavigationMode, NavigationMode.New);
        ...
        public static async Task onNavigatingToAsync(object page, INavigationParameters parameters)
        {
            if (page != null)
                PageUtilities.InvokeViewAndViewModelAction<INavigatingAware>(page, v => v.OnNavigatingTo(parameters));
        }

        static async Task OnNavigatingToAsync(Page toPage, INavigationParameters parameters)
        {
            await onNavigatingToAsync(toPage, parameters);
            ...
            if (toPage is TabbedPage tabbedPage)
            {
                foreach (var child in tabbedPage.Children)
                {
                    ...
                    {
                        await onNavigatingToAsync(child, parameters);
                    }
                }
            }
        ...
        {
            return HasNavigationPageParent(currentPage) && IsSameOrSubclassOf<ContentPage>(nextPageType);
        }
